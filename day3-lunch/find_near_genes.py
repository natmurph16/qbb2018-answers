...
#Find the nearest protein-coding gene to 3R:21,378,950 for Drosophila
...
print("Nearest protein coding gene:", genes_dict[dist_min])

#Output saved as near_gene_coding
